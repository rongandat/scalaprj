...
// Display a list
      ...
      while ($manufacturers = tep_db_fetch_array($manufacturers_query)) {
        ...
        $manufacturers_list .= '<a class="remote" href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers_id=' . $manufacturers['manufacturers_id']) . '">' . $manufacturers_name . '</a><br>';
      }
...
// Display a drop-down
      ...
      $info_box_contents = array();
      $info_box_contents[] = array('form' => tep_draw_form('manufacturers', tep_href_link(FILENAME_DEFAULT, '', 'NONSSL', false), 'get', 'class="ajaxform"'),
