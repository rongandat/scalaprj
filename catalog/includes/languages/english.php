...
define('HEADER_TITLE_CART_CONTENTS', 'Order List');
define('HEADER_TITLE_CHECKOUT', 'Checkout');
define('HEADER_TITLE_TOP', 'Main Website');
...
define('BOX_HEADING_WHATS_NEW', 'Recent Items');
...
define('BOX_HEADING_INFORMATION', 'Information Center');
...
define('IMAGE_BUTTON_BUY_NOW', 'View Details');
...
define('IMAGE_BUTTON_IN_CART', 'Add to Order list');
...
define('TEXT_GREETING_PERSONAL', 'Hello <span class="greetUser">%s</span>, welcome to the Scala Luxury Web Catalog!');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a class="remote" href="%s"><u>log yourself in</u></a> with your account information.</small>');
define('TEXT_GREETING_GUEST', 'Hello <span class="greetUser">Dear,</span></u></a>');
...
define('FOOTER_TEXT_BODY', 'Copyright � 2010 Scala Luxury, LLC');
...
define('ENTRY_GROUP_ERROR', 'Please select your business');
...
define('TABLE_HEADING_PRODUCTS_MODEL', 'Item Code');
