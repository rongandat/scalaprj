...
$products_attributes_query = tep_db_query("SELECT pa.options_id, pa.options_values_id, pa.options_values_price, pa.price_prefix, pa.options_values_width, pa.options_values_height, pa.options_values_depth
...
while ($products_attributes_values = tep_db_fetch_array($products_attributes_query)) {
	if ($products_attributes_values['options_values_width']!="" && $products_attributes_values['options_values_width']!="0" && $products_attributes_values['options_values_width']!="0.00") {
	 if ($width=='' || $width=='0.00') $width=$products_attributes_values['options_values_width'];
	 echo '<input class="options_values_width" name="options_values_width['.$products_attributes_values['options_values_id'].']" type="hidden" value="'.$products_attributes_values['options_values_width'].'">';
	}

	if ($products_attributes_values['options_values_height']!="" && $products_attributes_values['options_values_height']!="0" && $products_attributes_values['options_values_height']!="0.00") {
	 if ($height=='' || $height=='0.00') $height=$products_attributes_values['options_values_height'];
	 echo '<input class="options_values_height" name="options_values_height['.$products_attributes_values['options_values_id'].']" type="hidden" value="'.$products_attributes_values['options_values_height'].'">';
	}

	if ($products_attributes_values['options_values_depth']!="" && $products_attributes_values['options_values_depth']!="0" && $products_attributes_values['options_values_depth']!="0.00") {
	 if ($depth=='' || $depth=='0.00') $depth=$products_attributes_values['options_values_depth'];
	 echo '<input class="options_values_depth" name="options_values_depth['.$products_attributes_values['options_values_id'].']" type="hidden" value="'.$products_attributes_values['options_values_depth'].'">';
	}
...
$rowscounter = 0;
$html_ev_out = '<table border="0" cellspacing="0" cellpadding="0"><tr><td align="left"><strong><span class="smallText">' . STOCK_LIST_IN_PI_TEXT_HEADING . '</span></strong></td></tr>
