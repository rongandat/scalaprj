...
define('TEXT_GREETING_PERSONAL', 'Sch&ouml;n das Sie wieder da sind <span class="greetUser">%s!</span> M&ouml;chten Sie die <a class="remote" href="%s"><u>neue Produkte</u></a> ansehen?');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>Wenn Sie nicht %s sind, melden Sie sich bitte <a class="remote" href="%s"><u>hier</u></a> mit Ihrem Kundenkonto an.</small>');
define('TEXT_GREETING_GUEST', 'Herzlich Willkommen <span class="greetUser">Gast!</span> M&ouml;chten Sie sich <a class="remote" href="%s"><u>anmelden</u></a>? Oder wollen Sie ein <a class="remote" href="%s"><u>Kundenkonto</u></a> er&ouml;ffnen?');
...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a class="remote" href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br>Powered by <a class="remote" href="http://www.oscommerce.com" target="_blank">osCommerce</a>');
?>
