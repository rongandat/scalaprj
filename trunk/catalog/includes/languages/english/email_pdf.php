...
define('ERROR_TO_NAME', 'Error: Your clients name must not be empty.');
define('ERROR_TO_ADDRESS', 'Error: Your clients e-mail address must be a valid e-mail address.');
...
define('ERROR_TO_ADDRESS_CC', 'Error: Your Cc e-mail address must be a valid e-mail address.');
?>
