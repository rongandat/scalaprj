...
class mtheme_Recent_Posts extends WP_Widget {
	...
	function mtheme_Recent_Posts() {
		...
		$this->WP_Widget('recent_posts', MTHEME_WIDGET_PREFIX.' - '.__('Recent Posts', 'mthemelocal'), $widget_ops);
...
add_action('widgets_init', create_function('', 'return register_widget("mtheme_Recent_Posts");'));
?>