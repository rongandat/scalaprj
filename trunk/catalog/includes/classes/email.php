...
/**
 * Adds string data to the list of attachments.
 * Added by chris23 to allow string attachment of fpdf (mode 'S') generated pdf documents.
 */

    function add_string_attachment($string, $filename, $c_type='application/octet-stream', $encoding = 'base64') {
      $this->attachments[] = array('body' => $string,
                                   'name' => $filename,
                                   'c_type' => $c_type,
                                   'encoding' => $encoding);
    }
