<div class="title-container-wrap">
	<div class="title-container clearfix">
		...
		if ($mtheme_pagestyle=="fullwidth") { $floatside=""; }
		if ($mtheme_pagestyle=="rightsidebar") { $floatside="float-left"; }
		if ($mtheme_pagestyle=="leftsidebar") { $floatside="float-right"; }
		?>
		<div class="entry-title <?php echo $floatside . " "; if ( $mtheme_pagestyle != "nosidebar" && $mtheme_pagestyle !='' && $mtheme_pagestyle != "fullwidth" ) { echo 'two-column'; } ?>">
			<h1>
			<?php if ( is_day() ) : ?>
