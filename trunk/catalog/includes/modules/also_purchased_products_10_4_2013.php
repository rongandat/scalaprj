...
<?php
      ...
      while ($orders = tep_db_fetch_array($orders_query)) {
        ...
        $info_box_contents[$row][$col] = array('align' => 'center',
                                               ...
                                               'text' => '<a class="remote" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $orders['products_image'], $orders['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br><a class="remote" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . $orders['products_name'] . '</a>');
