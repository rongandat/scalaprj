...
class WorkETC
{
    ...
    private $options = array(
        ...
        'url' => 'http://%alias%.worketc.com/xml?wsdl',
    ...
    public function login($email, $pass, $options=array())
    {
        ...
        if($url_header[0] == 'HTTP/1.1 404 Not Found' || !$url_header) return false;
    ...
    public function getUrl() { 
        //return str_replace("%alias%", $this->options['alias'], $this->options['url']); 
        return HTTPS_SERVER.DIR_WS_CATALOG.'worketc.xml';
    }
