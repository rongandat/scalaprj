...
// BOF: Product Listing in Columns
  ...
  define('FILENAME_PRINT_CATALOG', 'print_catalog.php'); 
        ...
        /***********************************/
  define('FILENAME_SHOPPING_CART_CS', 'shopping_cart_cs.php');
  define('FILENAME_SHOPPING_CART_FV', 'shopping_cart_fv.php');
  define('FILENAME_SHOPPING_CART_PR', 'shopping_cart_pr.php');
?>