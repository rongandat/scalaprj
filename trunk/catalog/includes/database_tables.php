...
// define the database table names used in the project
  ...
  define('TABLE_CUSTOMERS_BASKET_CS', 'customers_basket_cs');
  define('TABLE_CUSTOMERS_BASKET_ATTRIBUTES_CS', 'customers_basket_attributes_cs');

  define('TABLE_CUSTOMERS_BASKET_FV', 'customers_basket_fv');
  define('TABLE_CUSTOMERS_BASKET_ATTRIBUTES_FV', 'customers_basket_attributes_fv');

  define('TABLE_CUSTOMERS_BASKET_PR', 'customers_basket_pr');
  define('TABLE_CUSTOMERS_BASKET_ATTRIBUTES_PR', 'customers_basket_attributes_pr');
...
//++++ QT Pro: End Changed Code	  
  ...
  define('TABLE_HOME_SLIDE_IMAGES', 'home_slide_images');
?>