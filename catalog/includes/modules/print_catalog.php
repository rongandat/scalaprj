...
<?php 
 echo '<a class="remote" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $print_catalog_array[$i]['id'], 'NONSSL') . '"><b> ' . $print_catalog_array[$i]['name'] . ' </b></a> '; 
?>	 
  </td>
 </tr>    
 <tr>
...
<?php 
 echo '<a class="remote" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $print_catalog_array[$i]['id'], 'NONSSL') . '"><img border="0" height="80" width="100" src="http://www.scalaluxury.com/catalog/images/' . $print_catalog_array[$i]['image'] . '"></a>'; 
?>
    </td>
<!-- product description -->
