...
define('HEADING_TITLE_2', 'Search Results');

define('HEADING_SEARCH_CRITERIA', 'Advanced Search - Please write your search term');
...
define('TEXT_SEARCH_HELP', 'Keywords may be separated by AND and/or OR statements for greater control of the search results.<br><br>For example, <u>Parchment AND Console</u> would generate a result set that contain both words. However, for <u>Parchment OR Console</u>, the result set returned would contain both or either words.<br><br>Exact matches can be searched for by enclosing keywords in double-quotes.<br><br>For example, <u>"parchment console"</u> would generate a result set which match the exact string.<br><br>Brackets can be used for further control on the result set.<br><br>For example, <u>Parchment and (console or mirror or "parchment console")</u>.');
...
define('TEXT_NO_PRODUCTS', 'Sorry, could not find anything for your search, please try again with different words, or view the categories on the left.');
...
define('TOP_TEXT_GUIDE_SEARCH', 'Please search by any of the criteria below. Also use terms such as "Chair", "Console", "Buffet" to get the best results!');
define('TOP_TEXT_CATEGORY', 'All Categories');
?>
