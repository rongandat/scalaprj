...
(function($) {
    $(window).load(function() {
        ...
        jQuery("a.ajax-hide").click(
                function() {
                    if (jQuery(".ajax-gridblock-window").is(':animated') || jQuery(".ajax-gridblock-image-wrap").is(':animated'))
                        return;
        ...
        function AjaxNavigation() {
            ...
            $('.ajax-next').click(function() {
                ...
                if ($(".ajax-gridblock-window").is(':animated') || $(".ajax-gridblock-image-wrap").is(':animated'))
                    return;
