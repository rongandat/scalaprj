<?php
/*
Plugin Name: iMaginem Shortcodes Generator
Plugin URI: http://www.imaginemthemes.com
Description: Imaginem Themes Shortcode Generator.
Version: 2.4.1
Author: iMaginem
...
class mthemeShortcodes {
	...
	function admin_init()
	{
		...
		wp_enqueue_style( 'font-awesome', mtheme_TINYMCE_URI . '/css/font-awesome/css/font-awesome.css', false, '1.0', 'all' );
