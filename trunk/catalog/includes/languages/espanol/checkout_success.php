...
define('TEXT_SEE_ORDERS', 'Puede ver sus pedidos viendo la pagina de <a class="remote" href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">\'Su Cuenta\'</a> y pulsando sobre <a class="remote" href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">\'Historial\'</a>.');
define('TEXT_CONTACT_STORE_OWNER', 'Dirija sus preguntas al <a class="remote" href="' . tep_href_link(FILENAME_CONTACT_US) . '">administrador</a>.');
