...
if(!in_array('MagicZoomPlusModuleCoreClass', get_declared_classes())) {
	...
	class MagicZoomPlusModuleCoreClass {
		...
		function headers($jsPath = '', $cssPath = null, $notCheck = false) {
			...
			$headers = array();
            $headers[] = '<!-- Magic Zoom Plus osCommerce module version 3.42.2.2 -->';         
        ...
        function template($params) {
            ...
            if($this->params->checkValue('show-caption', 'Yes')) {
                if($this->params->checkValue('caption-source', array('Title','Both')) && !empty($title)) $description_new = "<b>{$title}</b><br />";
                else $description_new = '';
                if($this->params->checkValue('caption-source', array('Description','Both')) && !empty($description)) $description_new .= $description;
            } else $description_new = '';
        ...
        "zoom-distance" => array(
            "id" => "zoom-distance",
            "default" => "15",
            "label" => "Distance between small image and zoom window (in pixels)",
            "type" => "num",
        ...
        "smoothing" => array(
            "id" => "smoothing",
            "default" => "Yes",
            "label" => "Enable smooth zoom movement",
            "type" => "array",
        ...
        "smoothing-speed" => array(
            "id" => "smoothing-speed",
            "default" => "40",
            "label" => "Speed of smoothing (1-99)",
            "type" => "num",
            
        ),
    
        "opacity-reverse" => array(
            "id" => "opacity-reverse",
            "default" => "No",
            "label" => "Add opacity to background instead of hovered area",
            "type" => "array",
        ...
        "click-to-initialize" => array(
            ...
            "default" => "No",
            "label" => "Click to initialize Magic Zoom and download large image",
            "type" => "array",
        ...
        "click-to-activate" => array(
            "id" => "click-to-activate",
            "default" => "No",
            "label" => "Click to show the zoom",
            "type" => "array",
        ...
        "show-title" => array(
            "id" => "show-title",
            "default" => "top",
            "label" => "Show the title of the image in the zoom window",
            "type" => "array",
            
            "subType" => "select",
            "values" => array("top","bottom","disable",),
            
        ),
    
        "selectors-mouseover-delay" => array(
            "id" => "selectors-mouseover-delay",
            "default" => "200",
            "label" => "Multiple images delay in ms before switching thumbnails",
            "type" => "num",
            
        ),
    
        "preload-selectors-small" => array(
            "id" => "preload-selectors-small",
            "default" => "Yes",
            "label" => "Multiple images, preload small images",
            "type" => "array",
        ...
        "preload-selectors-big" => array(
            "id" => "preload-selectors-big",
            "default" => "No",
            "label" => "Multiple images, preload large images",
            "type" => "array",
        ...
        "zoom-fade-in-speed" => array(
            "id" => "zoom-fade-in-speed",
            "default" => "200",
            "label" => "Zoom window fade-in speed (in milliseconds)",
            "type" => "num",
            
        ),
    
        "zoom-fade-out-speed" => array(
            "id" => "zoom-fade-out-speed",
            "default" => "200",
            "label" => "Zoom window fade-out speed  (in milliseconds)",
            "type" => "num",
        ...
        "fps" => array(
            "id" => "fps",
            "default" => "25",
            "label" => "Frames per second for zoom effect",
            "type" => "num",
        ...
        "loading-opacity" => array(
            "id" => "loading-opacity",
            "default" => "75",
            "label" => "Loading message opacity (0-100)",
            "type" => "num",
            
        ),
    
        "loading-position-x" => array(
            "id" => "loading-position-x",
            "default" => "-1",
            "label" => "Loading message X-axis position, -1 is center",
            "type" => "num",
            
        ),
    
        "loading-position-y" => array(
            "id" => "loading-position-y",
            "default" => "-1",
            "label" => "Loading message Y-axis position, -1 is center",
            "type" => "num",
        ...
        "move-on-click" => array(
            "id" => "move-on-click",
            "default" => "Yes",
            "label" => "Click alone will also move zoom (drag mode only)",
            "type" => "array",
        ...
        "x" => array(
            "id" => "x",
            "default" => "-1",
            "label" => "Initial zoom X-axis position for drag mode, -1 is center",
            "type" => "num",
        ...
        "y" => array(
            "id" => "y",
            "default" => "-1",
            "label" => "Initial zoom Y-axis position for drag mode, -1 is center",
            "type" => "num",
            
        ),
    
        "preserve-position" => array(
            "id" => "preserve-position",
            "default" => "No",
            "label" => "Position of zoom can be remembered for multiple images and drag mode",
            "type" => "array",
        ...
        "fit-zoom-window" => array(
            "id" => "fit-zoom-window",
            "default" => "Yes",
            "label" => "Resize zoom window if big image is smaller than zoom window",
            "type" => "array",
        ...
        "selectors-effect" => array(
            "id" => "selectors-effect",
            "default" => "dissolve",
            "label" => "Dissolve or cross fade thumbnail when switching thumbnails",
            "type" => "array",
            
            "subType" => "select",
            "values" => array("dissolve","fade","disable",),
            
        ),
    
        "selectors-effect-speed" => array(
            "id" => "selectors-effect-speed",
            "default" => "400",
            "label" => "Selectors effect speed, ms",
            "type" => "num",
        ...
        "entire-image" => array(
            "id" => "entire-image",
            "default" => "No",
            "label" => "Show entire large image on hover",
            "type" => "array",
